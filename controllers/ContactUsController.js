...
async function createRecord(req, res) {
    try {
        ...
        mailer.sendMail({
            ...
            to: data.email,
            subject: "Your Query Has Been Received  : Team OwnChoice",
            text: `
                    Hello ${data.name}
        ...
        mailer.sendMail({
            ...
            subject: "Your Query Has Been Received  : Team OwnChoice",
            html:`
            <table border="2px" cellpadding="10px" celspacing="0">
                <tbody>
    ...
    try {
        ...
        if (data) {
            ...
            mailer.sendMail({
                from: process.env.MAIL_SENDER,
                to: data.email,
                subject: "Your Query Status  Has Been Updated  : Team OwnChoice",
                text: `
                        Hello ${data.name}
