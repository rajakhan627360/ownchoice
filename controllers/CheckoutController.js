...
async function createRecord(req, res) {
    try {
        ...
        mailer.sendMail({
            ...
            to: user.email,
            subject: "Your Order Has Been Placed  : Team OwnChoice",
            text: `
                    Hello ${user.name}
                    Your Order Has Been Placed Successfully
                    Now You Can Track Youe Order In Profile Page Of Owr Website
                    Team : OwnChoice
            `
        }, (error) => {
            if (error)
    ...
    try {
        ...
        if (data) {
            ...
            mailer.sendMail({
                from: process.env.MAIL_SENDER,
                to: user.email,
                subject: "Your Order Has Been Updated  : Team OwnChoice",
                text: `
                        Hello ${user.name}
